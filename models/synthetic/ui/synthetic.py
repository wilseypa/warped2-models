...
def nw(*args):
    if networkV.get() == 'Watts-Strogatz':
        mean_degreeL = Label(n, text = 'Mean Degree').grid(row = 1, column = 1)
        probabilityL = Label(n, text = 'Probability').grid(row = 1, column = 3)
        mean_degree = Entry(n).grid(row = 1, column = 2)
        probability = Entry(n).grid(row = 1, column = 4)

    elif networkV.get() == 'Barabasi-Albert':
        mean_degreeL = Label(n, text = '').grid(row = 1, column = 1)
        probabilityL = Label(n, text = 'Probability').grid(row = 1, column = 3)
        mean_degree = Entry(n).grid(row = 1, column = 2)
        probability = Entry(n).grid(row = 1, column = 4)
...
def es_choice(*args):
    if esV.get() == 'Exponential':
        es_l1 = Label(es, text = 'Lambda')
        es_l1.grid(row = 1, column = 1)
        es_l2 = Label(es, text = 'Ceiling')
        es_l2.grid(row = 1, column = 3)
        es_l3 = Label(es, text = '').grid(row = 1, column = 5)
        es_v1.grid(row = 1, column = 2)
        es_v2.grid(row = 1, column = 4)
        es_v3.grid_remove()

    elif esV.get() == 'Geometric':
        es_l1 = Label(es, text = 'Probabiity of Success').grid(row = 1, column = 1)
        es_l2 = Label(es, text = 'Ceiling').grid(row = 1, column = 3)
        es_l3 = Label(es, text = '').grid(row = 1, column = 5)
        es_v1.grid(row = 1, column = 2)
        es_v2.grid(row = 1, column = 4)
        es_v3.grid_remove()
        ...
        es_l1 = Label(es, text = 'Mean').grid(row = 1, column = 1)
        es_l2 = Label(es, text = 'Standard Deviation').grid(row = 1, column = 3)
        es_l3 = Label(es, text = 'Ceiling').grid(row = 1, column = 5)
        es_v1.grid(row = 1, column = 2)
        es_v2.grid(row = 1, column = 4)
        es_v3.grid(row = 1, column = 6)

    elif esV.get() == 'Uniform':
        es_l1 = Label(es, text = 'Upper Bound').grid(row = 1, column = 1)
        es_l2 = Label(es, text = 'Lower Bound').grid(row = 1, column = 3)
        es_l3 = Label(es, text = 'Ceiling').grid(row = 1, column = 5)
        es_v1.grid(row = 1, column = 2)
        es_v2.grid(row = 1, column = 4)
        es_v3.grid(row = 1, column = 6)
        ...
        es_l1 = Label(es, text = 'Mean(>3)').grid(row = 1, column = 1)
        es_l2 = Label(es, text = 'Ceiling').grid(row = 1, column = 3)
        es_l3 = Label(es, text = '').grid(row = 1, column = 5)
        es_v1.grid(row = 1, column = 2)
        es_v2.grid(row = 1, column = 4)
...
def ns_choice(*args):
    if nsV.get() == 'Exponential':
        ns_l1 = Label(ns, text = 'Lambda').grid(row = 1, column = 1)
        ns_l2 = Label(ns, text = '').grid(row = 1, column = 3)
        ns_l3 = Label(ns, text = '').grid(row = 1, column = 5)
        ns_v1.grid(row = 1, column = 2)
        ns_v2.grid_remove()
        ns_v3.grid_remove()

    elif nsV.get() == 'Geometric':
        ns_l1 = Label(ns, text = 'Probabiity of Success').grid(row = 1, column = 1)
        ns_l2 = Label(ns, text = '').grid(row = 1, column = 3)
        ns_l3 = Label(ns, text = '').grid(row = 1, column = 5)
        ns_v1.grid(row = 1, column = 2)
        ns_v2.grid_remove()
        ...
        ns_l1 = Label(ns, text = 'Mean').grid(row = 1, column = 1)
        ns_l2 = Label(ns, text = 'Standard Deviation').grid(row = 1, column = 3)
        ns_l3 = Label(ns, text = '').grid(row = 1, column = 5)
        ns_v1.grid(row = 1, column = 2)
        ...
        ns_l1 = Label(ns, text = 'Upper Bound').grid(row = 1, column = 1)
        ns_l2 = Label(ns, text = 'Lower Bound').grid(row = 1, column = 3)
        ns_l3 = Label(ns, text = '').grid(row = 1, column = 5)
        ns_v1.grid(row = 1, column = 2)
        ns_v2.grid(row = 1, column = 4)
        ns_v3.grid_remove()
        ...
        ns_l1 = Label(ns, text = 'Mean(>3)').grid(row = 1, column = 1)
        ns_l2 = Label(ns, text = '').grid(row = 1, column = 3)
        ns_l3 = Label(ns, text = '').grid(row = 1, column = 5)
        ns_v1.grid(row = 1, column = 2)
        ns_v2.grid_remove()
...
ns_l1 = Label(ns, text = '').grid(row = 1, column = 1)
ns_l2 = Label(ns, text = '').grid(row = 1, column = 3)
ns_l3 = Label(ns, text = '').grid(row = 1, column = 5)
ns_v1 = Entry(ns)
ns_v2 = Entry(ns)
